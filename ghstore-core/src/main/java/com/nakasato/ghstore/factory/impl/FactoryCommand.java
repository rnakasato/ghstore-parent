...
import com.nakasato.ghstore.core.command.impl.CommandDoRule;
...
public class FactoryCommand {
	...
	public static Command build(AbstractDomainEntity entity,String operation, int parameter) throws ClassNotFoundException{
		if(commandMap == null){
			initCommands();
		}
		Command command = commandMap.get(operation);
