...
import com.nakasato.ghstore.core.dao.impl.PhoneDAO;
import com.nakasato.ghstore.core.dao.impl.ProductDAO;
import com.nakasato.ghstore.core.dao.impl.ShoppingCartDAO;
import com.nakasato.ghstore.core.dao.impl.ShoppingCartItemDAO;
...
public class FactoryDAO {
	...
	private static void initMap(){
		if(daoMap == null){
			...
			daoMap.put(Phone.class.getName(), new PhoneDAO());
			...
			daoMap.put(ShoppingCartItem.class.getName(), new ShoppingCartItemDAO());
