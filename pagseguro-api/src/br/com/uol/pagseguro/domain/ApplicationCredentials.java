...
public class ApplicationCredentials extends Credentials {
	...
	public ApplicationCredentials( String productionAppId, String productionAppKey, String sandboxAppId,
		...
		this.authorizationCode = authorizationCode != null && ! "".equals( authorizationCode.trim() )
				? authorizationCode.trim(): null;
	}
	...
	/**
	 * @param productionAppId
	 *            the production application ID account to set. Max length 60
	 *            characters.
	 */
	...
	/**
	 * @param sandboxAppId
	 *            the sandbox application ID account to set. Max length 60
	 *            characters.
	 */
	...
	/**
	 * @param productionAppkey
	 *            the production application key account to set. Max length 32
	 *            characters.
	 */
	...
	/**
	 * @param sandboxAppkey
	 *            the sandbox application key account to set. Max length 32
	 *            characters.
	 */
