...
public class PagSeguroSystem {
	...
	public static String getUrlPaymentRequest() {
		return resourceBundle
				.getString( "paymentRequestService." + PagSeguroConfig.getEnvironment() + ".paymentRequestUrl" );
	}
	...
	public static String getUrlAuthorization() {
		return resourceBundle
				.getString( "authorizationService." + PagSeguroConfig.getEnvironment() + ".authorizationUrl" );
	}
